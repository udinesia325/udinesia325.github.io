...
function Divider() {
  return (
    <div className='w-full bg-gray-900 py-10 flex flex-col justify-center items-center'>
        ...
        <a href={sendWhatsapp('Halo fahrudin, saya ingin bekerja sama dengan anda')} target='_blank' className='btn-primary mt-5 text-sm font-semibold text-center inline-flex items-center gap-x-5'>Let's Work Together <Icon icon='gg:arrow-right' className='text-lg' /></a>
    </div>
  )
}
