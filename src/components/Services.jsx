    ...
    <div id='services' className="py-10 bg-gray-100 flex place-items-center place-content-center">
      <div className="w-full sm:max-w-2xl flex flex-col sm:flex-row justify-center gap-10 p-2 lg:max-w-3xl">
        <div className="basis-1/2 flex flex-col justify-center items-start" data-aos='fade-up'>
          <h1 className="text-3xl font-semibold lg:text-4xl">What I do ?</h1>
          <p className="font-light text-gray-500 text-xs mt-5 lg:text-sm">
          ...
          <p className="font-light text-gray-500 text-xs mt-1 lg:text-sm">
        ...
        <div className="basis-1/2 flex flex-col gap-4" data-aos='fade-up'>
            {services.map((service , index) => (
                <div data-aos='fade-up' data-aos-delay={100 * index} key={index} className="flex flex-col gap-3 p-4 bg-white transition-all cursor-pointer hover:border-l-2 hover:border-l-primary-500">
                    <h1 className='text-sm font-semibold lg:text-lg'>{service.title}</h1>
                    <p className='text-xs text-gray-600 font-light lg:text-sm'>{service.description}</p>
                </div>
            ))}
        </div>
      </div>
