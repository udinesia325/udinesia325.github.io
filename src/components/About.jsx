...
function About() {
  return (
    <div className="w-[90%] mx-auto sm:h-[350px] bg-white rounded-lg shadow-2xl p-10 mt-20 flex flex-col gap-y-4 sm:flex-row items-center translate-y-40 -bottom-20">
      <div className="basis-1/2 flex place-content-center relative">
        ...
        />
        <div className='p-2 bg-white shadow-md rounded-md absolute z-[2] -bottom-4 flex gap-x-5'>
