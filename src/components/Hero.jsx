            ...
            <div className='w-full md:pt-10'>
                <div className="flex flex-col px-3 gap-y-4 justify-center items-stretch gap-x-4 sm:flex-row">
                    ...
                    <div className='flex flex-col gap-y-4 basis-1/2 items-start mt-10'>
                        <h1 className='text-4xl text-gray-900 font-semibold lg:text-5xl' data-aos='fade-in'>Hello, I'm Ahmad<br /> Fahruddin Salim</h1>
                        <p data-aos='fade-in' data-aos-delay='100' className='text-sm text-gray-900 lg:text-lg'>Welcome to my portfolio, I'm a dedicated Fullstack Web Developer with a fervor for creating robust and user-friendly digital solution</p>
